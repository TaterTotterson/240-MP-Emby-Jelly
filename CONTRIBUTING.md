...
A pure-QML module needs **no C++ changes** — the shell discovers it from its manifest. `EmbyJellyfinBackend` is the most complete backend and the best one to study.
